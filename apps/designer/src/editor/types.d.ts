...
declare namespace objectUtil {
  ...
  export type addQuestionMarks<T extends object, R extends keyof T = requiredKeys<T>> = Pick<
    Required<T>,
    R
  > &
    Partial<T>
...
export declare type CatchallOutput<T extends ZodTypeAny> = ZodTypeAny extends T
  ? unknown
  : {
      [k: string]: T['_output']
    }
export declare type CatchallInput<T extends ZodTypeAny> = ZodTypeAny extends T
  ? unknown
  : {
      [k: string]: T['_input']
    }
export declare type PassthroughType<T extends UnknownKeysParam> = T extends 'passthrough'
  ...
  : unknown
export declare type deoptional<T extends ZodTypeAny> = T extends ZodOptional<infer U>
  ? deoptional<U>
...
> extends ZodType<Output, ZodObjectDef<T, UnknownKeys, Catchall>, Input> {
  ...
  augment: <Augmentation extends ZodRawShape>(
    ...
    {
      [k in keyof (Omit<T, keyof Augmentation> & Augmentation)]: (Omit<T, keyof Augmentation> &
        Augmentation)[k]
    },
    UnknownKeys,
    Catchall,
  ...
  static create: <T_1 extends ZodRawShape>(
    ...
    ZodTypeAny,
    {
      [k_1 in keyof objectUtil.addQuestionMarks<
        ...
        {
          [k in keyof baseObjectOutputType<T_1>]: undefined extends baseObjectOutputType<T_1>[k]
            ? never
            : k
        }[keyof T_1]
...
declare const parameterOptionsSchema: ZodDiscriminatedUnion<
  'type',
  [
    ZodObject<
      {
...
declare function ParametersOptions<ParamsOptions extends ParametersOptions>(
...
declare function Presets<ParamsOptions extends ParametersOptions>(
...
declare const designMetaSchema: ZodObject<
  {
    ...
    categories: ZodOptional<ZodArray<ZodEnum<['seating', 'tables', 'storage', 'office']>, 'many'>>
  },
  'strip',
  ZodTypeAny,
  {
