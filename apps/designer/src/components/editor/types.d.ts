...
export declare function DesignAssembly(assembly: Omit<DesignAssemblyStatic, "type">): DesignAssemblyStatic;
export interface DesignAssemblyParameterized<ParamsOptions extends ParametersOptions> extends DesignAssemblyBase {
	type: "parameterized";
	parameters: ParamsOptions;
	presets: Presets<ParamsOptions>;
	createParts: (parameters: ExtractValuesFromParametersOptions<ParamsOptions>, partVariants: PartVariantsByType) => DesignParts;
	plugins?: Array<AssemblyPlugin>;
}
export declare function DesignAssemblyParameterized<ParamsOptions extends ParametersOptions>(assembly: Omit<DesignAssemblyParameterized<ParamsOptions>, "type">): DesignAssemblyParameterized<ParamsOptions>;
...
declare const variants: Record<string, GridBeamVariant>;
...
declare const variants$1: Record<string, GridPanelVariant>;
